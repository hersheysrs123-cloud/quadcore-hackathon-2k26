  ...
  return (
    ...
    >
      <group position={[-1.2, 0, 0]}>
        ...
        {/* Active site: two jaws that spread apart as the enzyme denatures. */}
        <mesh position={[1.55, 0.62 + siteOpen * 0.55, 0]} rotation={[0, 0, -0.32 - siteOpen * 0.5]}>
        ...
        {mitochondria.map((p, i) => (
          <group key={i} position={p} rotation={[0, i * 0.8, 0.5]}>
            <Organelle
              id="mitochondrion"
              position={[0, 0, 0]}
              geometry={<capsuleGeometry args={[0.24, 0.62, 6, 16]} />}
              colour={PALETTE.rose}
