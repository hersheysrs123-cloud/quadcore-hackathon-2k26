...
export function VisualizationHUD({ topic, params, setParam, setParams, onReset, onOpenQuiz }) {
  ...
  return (
    <div className="pointer-events-auto absolute left-4 top-4 z-20 flex max-h-[calc(100%-2rem)] w-[264px] flex-col gap-3 overflow-y-auto pr-0.5">
      <HudPanel
        title={topic.title}
        icon={topic.icon}
        action={
      ...
      {/* 3-bullet IGCSE takeaways */}
      <HudPanel title="IGCSE key concepts" icon={Lightbulb}>
  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed left-1/2 top-1/2 z-[70] w-[min(580px,calc(100vw-2rem))] max-h-[calc(100vh-2rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-xl border border-ink-700 bg-ink-900 shadow-2xl"
      >
