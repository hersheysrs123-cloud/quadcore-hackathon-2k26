...
│       ├── ShadowLabCanvas.jsx           # Torch/object/screen bench; 8 shapes (incl. ring with open hole & pyramid), upright L-shadow alignment, smooth continuous corner rounding, dynamic anti-clipping pedestal clearance, detailed laboratory torch & wide troffer lamp, and resizable HUD
