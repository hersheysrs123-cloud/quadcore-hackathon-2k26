...
/**
 * In-situ power of the relaxed crystalline lens — about 20 D, which is what
 * biometry actually measures. The often-quoted "17 D" is what is left after
 * subtracting the cornea from 60 as though the two were in contact.
 */
 ...
 * at the lens, because the lens sits behind the cornea and only ~84% of what
 ...
 * out near 9.9 mm and the fully accommodated one near 6.2 mm, which is what
 * the anatomy books measure — the model is not fitted to them.
 */
