...
export function tryAutoFormatInlineMath(el) {
  ...
  if (match) {
    ...
    mathSpan.className =
      "katex-inline-node inline-flex items-center mx-1 px-2 py-0.5 rounded-md border border-duck-500/40 bg-duck-500/10 hover:bg-duck-500/25 hover:border-duck-400 text-duck-200 font-semibold cursor-pointer transition-all select-none group/mathpill";
