 ...
 */
export const SOLIDS = {
  wood: { label: "Oak", density: 0.6, colour: "#a9784a", title: "Seasoned oak — 0.60 g/cm³" },
  ice: { label: "Ice", density: 0.92, colour: "#bae6fd", title: "Ice — 0.92 g/cm³, and that is why it floats" },
  aluminium: { label: "Aluminium", density: 2.7, colour: "#cbd5e1", title: "Aluminium — 2.70 g/cm³" },
  steel: { label: "Steel", density: 7.85, colour: "#8996a8", title: "Steel — 7.85 g/cm³" },
  gold: { label: "Gold", density: 19.3, colour: "#fbbf24", title: "Gold — 19.30 g/cm³, denser than mercury" },
};
...
export function shapeMetrics(shape, volumeCC) {
  ...
  if (spec.envelope > 1) {
    // Box hull, 3 long × 1 wide × 1 deep.
    const a = Math.cbrt(envelope / 3);
    return { spec, key: shape, materialCC: material, envelopeCC: envelope, height: a, length: 3 * a, width: a, footprint: 3 * a * a };
  }
  if (shape === "sphere") {
