...
export const QUESTION_TYPES = ["multiple_choice", "short_answer", "long_answer"];
      ...
      items: {
        ...
        properties: {
          ...
          options: {
            type: "ARRAY",
            description:
              "Exactly 4 for multiple_choice, empty for short_answer and long_answer. Every " +
              "distractor must be a mistake a real learner would make, not filler.",
            items: { type: "STRING" },
          },
          correctIndex: {
            type: "NUMBER",
            description:
              ...
              "short_answer and long_answer. Vary the position across questions.",
          },
          expectedAnswer: {
            type: "STRING",
            description:
              "For short_answer and long_answer, the model answer/rubric to grade against. For " +
