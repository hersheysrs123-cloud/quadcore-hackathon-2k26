 ...
 *
 * Each pan sits on the dome, takes its share of the charge, and is repelled
 * by everything below it. The nth pan up is lighter-loaded than the one below,
 * so they leave one at a time from the top — which is exactly what the demo
