  ...
  // ── School ──────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      b(
        "eig_5_math",
        "math",
        "\\mathbf{A}\\mathbf{v} = \\lambda \\mathbf{v} \\quad \\implies \\quad (\\mathbf{A} - \\lambda \\mathbf{I}) \\mathbf{v} = \\mathbf{0}"
      ),
      b(
        "eig_32",
        "notelink",
        "Algorithmic Complexity Connection",
        { targetNoteTitle: "Big-O & Algorithmic Complexity" }
      ),
