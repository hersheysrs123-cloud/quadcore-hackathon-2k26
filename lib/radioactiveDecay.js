...
export const MODES = {
  ...
  beta_minus: {
    ...
    speedOfLight: 0.9,
    ionising: "moderate",
    range: "about a metre of air; stopped by a few mm of aluminium",
    note: "A neutron in the nucleus becomes a proton, and the electron that balances the charge leaves at close to the speed of light with an antineutrino. Z goes up by one; A does not change — this is the decay behind radiocarbon dating.",
    colour: "#38bdf8",
  },
  beta_plus: {
    label: "Beta-plus (β⁺)",
    ...
    speedOfLight: 0.9,
    ionising: "moderate",
    range: "about a metre of air; stopped by a few mm of aluminium — then annihilates",
  ...
  gamma: {
    ...
    speedOfLight: 1,
    ionising: "low",
    range: "hundreds of metres of air; reduced, never quite stopped, by thick lead",
...
export const PARTICLE_KINDS = {
  ...
  beta_minus: { colour: "#38bdf8", size: 0.045, speed: 7.5, charge: -1, massU: 0.00055, label: "β⁻" },
  beta_plus: { colour: "#fbbf24", size: 0.045, speed: 7.5, charge: 1, massU: 0.00055, label: "β⁺" },
...
export const BARRIERS = {
  ...
  lead: { label: "Lead", thickness: "10 cm", thicknessMm: 100, stops: ["alpha", "beta_minus", "beta_plus", "gamma"], colour: "#4b5563" },
};
 ...
 * fraction: nearly all through paper, most through aluminium, one in a
 * thousand through 10 cm of lead. Neutrinos get through everything.
 */
